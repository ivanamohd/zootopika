...
<form id="app-cover">
            <div id="select-box">
                    ...
                    <div id="options">
                            <div class="option">
                                    <input class="s-c top" type="radio" name="platform" value="admin">
                                    <input class="s-c bottom" type="radio" name="platform" value="admin">
                                    <i class="fab fa-admin"></i>
                                    <span class="label">Admin</span>
                                    <span class="opt-val">Admin</span>
									
                            </div>
                            <div class="option">
                                    <a href="staff/examples/login/index.php"> <input class="s-c top" type="radio" name="platform" value="staff"></a>
                                    <input class="s-c bottom" type="radio" name="platform" value="staff">
                                    <i class="fab fa-staff"></i>
                                    <span class="label">Staff</span>
                                    <span class="opt-val">Staff</span>
                            </div>
