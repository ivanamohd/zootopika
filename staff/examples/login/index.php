					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								<p>Username </p>
								<input type="text" class="text" value=""  name="staffName" required >
								<p>First Name </p>
								<input type="text" class="text" value=""  name="staffFN" required >
								<p>Last Name </p>
								...
								<p>Contact No. </p>
								<input type="text" value="" name="staffContact"  required>
								<div class="sign-up">
...
<?php
    ...
    $message = '
        ...
        http://localhost/masterfolder_zootopika/staff/examples/login/verify.php?staffEmail=' . $_POST['staffEmail'] . '&staffPassword=' . $_POST['staffPassword'] . '
